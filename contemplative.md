...
**Read before** changing direction here. **Edit in place** — git has the
history, this file is only the current answer.
...
shown the move you missed. Second buyer, second shape: method training for
